...
//     // parent div
//     <div className='w-screen h-100%! important'>

//       {/* logo */}
//      <div className='flex justify-between px-10 py-5 bg-green-700 items-center'>
...
//      {/* navbar */}
//      <div className='flex gap-10 font-serif text-lg text-white'>
//            <a href='/'>Home</a>
//            <a href='/'>About Us</a>
...
//        {/* button */}
//      <button className='text-lg text-white font-serif py-2 px-4 rounded-lg bg-slate-500'>
//       click me!
//      </button>
...
//      {/* Body */}
//      <div className='flex justify-center items-center gap-24 px-80 pt-40'>

//       <div>
//         <h1> Helloo Welcome to Anaamcara</h1>
...
//      {/* Footer */}
//      <div className='flex justify-center gap-12 mt-48'>

//       <div className='py-1 px-28 bg-gray-600 flex justify-center items-center text-white text-lg font-serif'>
//       AI logo
//       <img className='h-12 w-14' src='dull.png'/>
//       </div>

//       <div className='py-6 px-28 bg-gray-600 flex justify-center items-center text-white text-lg font-serif'>
//       AI logo
//       <img className='h-12 w-14' src='dull.png'/>
//       </div>
